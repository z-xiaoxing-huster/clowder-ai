...
const ICON_PATHS: Record<string, string> = {
  ...
  activity: 'M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36-3.18-11.64A2 2 0 0 0 10.13 9H9.87a2 2 0 0 0-1.93 1.46L6.59 15H2',
  users: 'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75',
  sparkles: 'M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.064 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0zM20 3v4M22 5h-4',
  'chart-pie': 'M21 12c.552 0 1.005-.449.95-.998a10 10 0 0 0-8.953-8.951c-.55-.055-.998.398-.998.95V12h9zM21.95 13.001c.055.55-.398.998-.95.998H12V5.002c0-.552-.449-1.005-.998-.95A10 10 0 1 0 21.95 13.002z',
  trophy: 'M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22M18 2H6v7a6 6 0 0 0 12 0V2z',
  folder: 'M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2z',
  'user-cog': 'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM19.7 14.4l-.9-.3a2 2 0 0 1 0-3.8l.9-.3a.5.5 0 0 0 .2-.8l-.6-.7a2 2 0 0 1-2.7-2.7l-.7-.6a.5.5 0 0 0-.8.2l-.3.9a2 2 0 0 1-3.8 0l-.3-.9a.5.5 0 0 0-.8-.2',
...
function AccordionSection({
  group, expanded, activeTab, onToggle, onSelectTab,
}: {
  group: HubGroup; expanded: boolean; activeTab: HubTabId;
  onToggle: () => void; onSelectTab: (tabId: HubTabId) => void;
}) {
  return (
